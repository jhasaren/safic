...
$(document).ready(function () {
    ...
    $('.btn-resol').click(function (e) {
        e.preventDefault();
        $('#myModal-resol').modal('show');
    });
    /*Modal - Crear Estudiante*/
    $('.btn-estudiante').click(function (e) {
        e.preventDefault();
        $('#myModal-est').modal('show');
    });
    /*Modal - Crear Curso*/
    $('.btn-curso').click(function (e) {
        e.preventDefault();
        $('#myModal-curso').modal('show');
    });
    /*Modal - Crear Jornada*/
    $('.btn-jornada').click(function (e) {
        e.preventDefault();
        $('#myModal-jornada').modal('show');
    });
    /*Modal - Crear Acudiente*/
    $('.btn-acudiente').click(function (e) {
        e.preventDefault();
        $('#myModal-acud').modal('show');
    });
    /*Modal - parmetrizar tarifa fija*/
    ...
    $('.btn-aplpago').click(function (e) {
        e.preventDefault();
        var idRecibo = $(this).attr('data-rel');
        var idEstudiante = $(this).attr('data-rel2');
        var valorRecaudo = $(this).attr('data-rel3');
        $("#idreciboapl").val(idRecibo);
        $("#idestudianteapl").val(idEstudiante);
        $("#valorrecaudo").val(valorRecaudo);
        $("#valorrecaudo_org").val(valorRecaudo);
        $('#myModal-aplpago').modal('show');
    });
    /*Modal - Anular Recibo*/
    $('.btn-anlrecibo').click(function (e) {
        e.preventDefault();
        var idRecibo = $(this).attr('data-rel');
        var idEstudiante = $(this).attr('data-rel2');
        $("#idreciboanl").val(idRecibo);
...
/*Iniciar con Menu cerrado - jasanchez*/
$(function() {
